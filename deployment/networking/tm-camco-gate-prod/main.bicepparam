...
param applicationName = 'camco-gate'
param agwOriginalPIPName = 'pip-ep-agw-camcogate-01'
param agwOriginalSubscriptionId = 'c71cfef2-700e-47e5-b810-e34898fd2249'
param agwOriginalResourceGroupName = 'rg-ep-camco-prod-01'
...
param healthProbeHostValue = 'camcogate.euroports.com'
