param applicationGateways_agw_bzt_integration_acc_westeu_01_name string = 'agw-bzt-integration-acc-westeu-01'
...
param publicIPAddresses_pip_ep_agw_integration_acc_01_externalid string = '/subscriptions/c2ae3152-6777-45b2-8c04-f4492ad08be4/resourceGroups/rg-ep-edi-test-01/providers/Microsoft.Network/publicIPAddresses/pip-ep-agw-integration-acc-01'

resource applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource 'Microsoft.Network/applicationGateways@2024-07-01' = {
  name: applicationGateways_agw_bzt_integration_acc_westeu_01_name
  location: 'westeurope'
  properties: {
    sku: {
      name: 'Standard_Small'
    ...
    gatewayIPConfigurations: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/gatewayIPConfigurations/appGatewayIpConfig'
        properties: {
          subnet: {
    ...
    sslCertificates: [
      {
        name: 'WildcardEuroports2023'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/sslCertificates/WildcardEuroports2023'
        properties: {}
      }
      {
        name: 'WildcardCertificate'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/sslCertificates/WildcardCertificate'
        properties: {}
      }
      {
        name: 'EuroportsWildcard20242025'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/sslCertificates/EuroportsWildcard20242025'
        properties: {}
      }
    ]
    authenticationCertificates: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/authenticationCertificates/Wildcard_Certificate'
        properties: {
      ...
      {
        name: 'WildcardEuroports2023'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/authenticationCertificates/WildcardEuroports2023'
        properties: {
      ...
      {
        name: 'WildcardEuroports2024'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/authenticationCertificates/WildcardEuroports2024'
        properties: {
      ...
      {
        name: 'EuroportsWildcard2025'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/authenticationCertificates/EuroportsWildcard2025'
        properties: {
    ...
    frontendIPConfigurations: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/frontendIPConfigurations/appGwPublicFrontendIp'
        properties: {
          privateIPAllocationMethod: 'Dynamic'
          publicIPAddress: {
            id: publicIPAddresses_pip_ep_agw_integration_acc_01_externalid
          }
        }
      }
    ]
    frontendPorts: [
      {
        name: 'port_443'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/frontendPorts/port_443'
        properties: {
          port: 443
        }
      }
      {
        name: 'port_80'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/frontendPorts/port_80'
        properties: {
          port: 80
        }
      }
      {
        name: 'port_445'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/frontendPorts/port_445'
        properties: {
          port: 445
        }
      }
    ...
    backendAddressPools: [
      {
        name: 'shrawe-bzt01.corp.euroports.com'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/backendAddressPools/shrawe-bzt01.corp.euroports.com'
        properties: {
          backendAddresses: [
            {
              fqdn: 'shrawe-bzt01.corp.euroports.com'
            }
          ]
        }
      }
    ...
    backendHttpSettingsCollection: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/backendHttpSettingsCollection/StandardHttpSettings'
        properties: {
          port: 443
          protocol: 'Https'
    ...
    httpListeners: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/httpListeners/Public-RedirectHttp'
        properties: {
      ...
      }
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/httpListeners/Public-ListenerStandard'
        properties: {
          frontendIPConfiguration: {
            id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/frontendIPConfigurations/appGwPublicFrontendIp'
          }
    ...
    requestRoutingRules: [
      {
        name: 'Public-ListenerStandard'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/requestRoutingRules/Public-ListenerStandard'
        properties: {
          ruleType: 'Basic'
          httpListener: {
            id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/httpListeners/Public-ListenerStandard'
      ...
      {
        name: 'Public-RedirectHttp'
        id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/requestRoutingRules/Public-RedirectHttp'
        properties: {
          ruleType: 'Basic'
          httpListener: {
            id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/httpListeners/Public-RedirectHttp'
          ...
          redirectConfiguration: {
            id: '${applicationGateways_agw_bzt_integration_acc_westeu_01_name_resource.id}/redirectConfigurations/Public-RedirectHttp'
          }
        }
      }
    ]
