param applicationGateways_agw_bzt_integration_prd_westeu_01_name string = 'agw-bzt-integration-prd-westeu-01'
...
param publicIPAddresses_pip_ep_agw_integration_prd_01_externalid string = '/subscriptions/c71cfef2-700e-47e5-b810-e34898fd2249/resourceGroups/rg-ep-edi-prod-01/providers/Microsoft.Network/publicIPAddresses/pip-ep-agw-integration-prd-01'

resource applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource 'Microsoft.Network/applicationGateways@2024-07-01' = {
  name: applicationGateways_agw_bzt_integration_prd_westeu_01_name
  location: 'westeurope'
  properties: {
    sku: {
      name: 'Standard_Small'
    ...
    gatewayIPConfigurations: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/gatewayIPConfigurations/appGatewayIpConfig'
        properties: {
          subnet: {
    ...
    sslCertificates: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/sslCertificates/WildcardCertificate'
        properties: {}
      }
      {
        name: 'EuroportsWildcard20242025'
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/sslCertificates/EuroportsWildcard20242025'
        properties: {}
      }
    ]
    authenticationCertificates: [
      {
        name: 'StandardHttpSettingsc866a324-800a-4609-ac25-d4eed2eaf104'
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/authenticationCertificates/StandardHttpSettingsc866a324-800a-4609-ac25-d4eed2eaf104'
        properties: {
      ...
      }
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/authenticationCertificates/WildcardEuroports2023'
        properties: {
      ...
      }
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/authenticationCertificates/WildcardEuroports2024'
        properties: {
      ...
      }
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/authenticationCertificates/EuroportsWildcard2025'
        properties: {
    ...
    frontendIPConfigurations: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/frontendIPConfigurations/appGwPublicFrontendIp'
        properties: {
          privateIPAllocationMethod: 'Dynamic'
          publicIPAddress: {
            id: publicIPAddresses_pip_ep_agw_integration_prd_01_externalid
          }
        }
      }
    ]
    frontendPorts: [
      {
        name: 'port_443'
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/frontendPorts/port_443'
        properties: {
          port: 443
        }
      }
    ...
    backendAddressPools: [
      {
        name: 'shrpwe-bzt01.corp.euroports.com'
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/backendAddressPools/shrpwe-bzt01.corp.euroports.com'
        properties: {
          backendAddresses: [
            {
    ...
    backendHttpSettingsCollection: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/backendHttpSettingsCollection/StandardHttpSettings'
        properties: {
          port: 443
          protocol: 'Https'
    ...
    httpListeners: [
      {
        ...
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/httpListeners/Public-ListenerStandard'
        properties: {
    ...
    requestRoutingRules: [
      {
        name: 'Public-ListenerStandard'
        id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/requestRoutingRules/Public-ListenerStandard'
        properties: {
          ruleType: 'Basic'
          httpListener: {
            id: '${applicationGateways_agw_bzt_integration_prd_westeu_01_name_resource.id}/httpListeners/Public-ListenerStandard'
