...
param applicationName = 'step-eterminal-auth'
param agwOriginalPIPName = 'pip-ep-agw-eterminal-auth-prd-01'
...
param healthProbePath = '/auth'
param healthProbeHostValue = 'ec524-auth.euroports.com'
...
param expectedStatusCodeRanges = [
  {
    max: 308
    min: 301
  }
