...
param applicationName = 'basculas-operativa-clientes'
param agwOriginalPIPName = 'pip-ep-agw-bascule-02'
param agwOriginalSubscriptionId = 'c71cfef2-700e-47e5-b810-e34898fd2249'
param agwOriginalResourceGroupName = 'rg-eps-bascule-prod-01'
...
param healthProbeHostValue = 'axbasculasoperativaclientes.euroports.com'
