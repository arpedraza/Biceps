...
param applicationName = 'apex'
param agwOriginalPIPName = 'pip-apex-prod-westeu-01'
param agwOriginalSubscriptionId = 'c71cfef2-700e-47e5-b810-e34898fd2249'
param agwOriginalResourceGroupName = 'rg-ep-apex-prod-01'
...
param healthProbeHostValue = 'e-bp.euroports.com'
