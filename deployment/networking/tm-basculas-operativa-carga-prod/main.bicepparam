...
param applicationName = 'basculas-operativa-carga'
param agwOriginalPIPName = 'pip-ep-agw-bascule-04'
...
param healthProbeHostValue = 'axbasculasoperativacarga.euroports.com'
