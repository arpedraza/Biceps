...
param agwResourceGroupName = 'rg-mrg-waf-nonprod-test-01'
...
param subnetName = 'snet-mrg-shared-waf-non-prod-test-westeu-01'
param appGatewayName = 'agw-edge-waf-nonprod-test-01'
param keyVaultName = 'kv-edge-waf-nonprod-01'
param managedIdentityName = 'umi-edge-waf-nonprod-test-01'
param publicIP = {
  name: 'pip-agw-edge-waf-nonprod-test-01'
  ...
  domainNameLabel: 'agwedgewafnonprodtest'
}
...
param frontendIPConfigurations = {
  ...
  privateIPAddress: '10.11.122.196'
  }
...
param httpListeners = [
  {
    ...
    firewallPolicy: '/subscriptions/9c9c8305-0566-47cb-9b82-5dcf99bed903/resourceGroups/rg-mrg-waf-nonprod-test-01/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/waf-policy-integration-acc'
  }
  {
    ...
    requireServerNameIndication: true
    firewallPolicy: '/subscriptions/9c9c8305-0566-47cb-9b82-5dcf99bed903/resourceGroups/rg-mrg-waf-nonprod-test-01/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/waf-policy-integration-tst'
  }
  {
    ...
    requireServerNameIndication: true
    firewallPolicy: '/subscriptions/9c9c8305-0566-47cb-9b82-5dcf99bed903/resourceGroups/rg-mrg-waf-nonprod-test-01/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/waf-policy-apex-dev'
  }
  {
    ...
    requireServerNameIndication: true
    firewallPolicy: '/subscriptions/9c9c8305-0566-47cb-9b82-5dcf99bed903/resourceGroups/rg-mrg-waf-nonprod-test-01/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/waf-policy-apex-test'
  }
  {
    ...
    requireServerNameIndication: true
    firewallPolicy: '/subscriptions/9c9c8305-0566-47cb-9b82-5dcf99bed903/resourceGroups/rg-mrg-waf-nonprod-test-01/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/waf-policy-ipos-doc-uat'
  }
  {
