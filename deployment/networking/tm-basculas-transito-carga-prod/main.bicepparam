...
param applicationName = 'basculas-transito-carga'
param agwOriginalPIPName = 'pip-ep-agw-bascule-03'
...
param healthProbeHostValue = 'axbasculastransitocarga.euroports.com'
