...
.EXAMPLE
Test-TemplateWithParameterFile templateFilePath 'modules/KeyVault/deploy.json' -parameterFilePath 'modules/KeyVault/.parameters/parameters.json' -location 'WestEurope' -resourceGroupName 'aLegendaryRg'
...
.EXAMPLE
Test-TemplateWithParameterFile templateFilePath 'modules/ResourceGroup/deploy.json' -parameterFilePath 'modules/ResourceGroup/.parameters/parameters.json' -location 'WestEurope'
