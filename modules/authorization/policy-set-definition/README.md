...
```bicep
module policysetdefinition 'yourpath/module/Authorization.policySetDefinitions/subscription/main.bicep' = {}
```
...
- Policy Set Definitions (Initiatives) have a dependency on Policy Assignments being applied before creating an initiative. You can use the Policy Assignment [Module](../policy-definition/main.bicep) to deploy a Policy Definition and then create an initiative for it on the required scope.
